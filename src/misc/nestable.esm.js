...
Plugin.prototype = {
  ...
  init: function () {
    ...
    list.el.nestableGroup = this.options.group
    ...
    if (hasTouch) {
      ...
      document.addEventListener(eMove, onMoveEvent)
      document.addEventListener(eEnd, onEndEvent)
    }
    ...
    var destroyNestable = function () {
      if (hasTouch) {
        ...
        document.removeEventListener(eMove, onMoveEvent)
        document.removeEventListener(eEnd, onEndEvent)
      }
  ...
  dragMove: function (e) {
    ...
    if (!mouse.dirAx || isNewRoot || isEmpty) {
      ...
      if (isNewRoot && opt.group !== pointElRoot.nestableGroup) {
        return
      }
